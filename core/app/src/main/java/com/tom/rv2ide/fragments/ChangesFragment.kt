...
class ChangesFragment : Fragment() {
        ...
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton("Kaydet") { _, _ ->
                ...
                if (message.isNotBlank()) {
                    ...
                    Snackbar.make(binding.root, "Commit mesajı boş bırakılamaz", Snackbar.LENGTH_SHORT).show()
                }
            }
    ...
    private fun showDiscardConfirmation(filePath: String) {
        MaterialAlertDialogBuilder(requireContext())
            .setTitle("Değişiklikleri At")
            .setMessage("$filePath içindeki değişiklikleri atmak istediğinizden emin misiniz? Bu işlem geri alınamaz.")
            .setPositiveButton("At") { _, _ ->
