...
Hata mesajını kontrol edip tekrar deneyin.
    ...
    private fun translateAiText(text: String): String {
        return text
            ...
            .replace("Anthropic service not initialized", "Anthropic hizmeti başlatılmadı")
            .replace("Anthropic rate limit exceeded: ", "Anthropic istek sınırı aşıldı: ")
            .replace("Anthropic quota exceeded: ", "Anthropic API kotası aşıldı: ")
            .replace("Invalid Anthropic API key: ", "Geçersiz Anthropic API anahtarı: ")
            .replace("Anthropic API error", "Anthropic API hatası")
            .replace("No response from Anthropic API", "Anthropic API'den yanıt alınamadı")
            .replace("Anthropic request timeout: ", "Anthropic isteğinde zaman aşımı: ")
            .replace("Network error - cannot reach Anthropic: ", "Ağ hatası - Anthropic'e ulaşılamadı: ")
            .replace("DeepSeek service not initialized", "DeepSeek hizmeti başlatılmadı")
            .replace("DeepSeek rate limit exceeded: ", "DeepSeek istek sınırı aşıldı: ")
            .replace("DeepSeek quota exceeded: ", "DeepSeek API kotası aşıldı: ")
            .replace("Invalid DeepSeek API key: ", "Geçersiz DeepSeek API anahtarı: ")
            .replace("DeepSeek API error", "DeepSeek API hatası")
            .replace("No response from DeepSeek API", "DeepSeek API'den yanıt alınamadı")
            .replace("DeepSeek request timeout: ", "DeepSeek isteğinde zaman aşımı: ")
            .replace("Network error - cannot reach DeepSeek: ", "Ağ hatası - DeepSeek'e ulaşılamadı: ")
            .replace("Grok service not initialized", "Grok hizmeti başlatılmadı")
            .replace("Grok rate limit exceeded: ", "Grok istek sınırı aşıldı: ")
            .replace("Grok quota exceeded: ", "Grok API kotası aşıldı: ")
            .replace("Invalid Grok API key: ", "Geçersiz Grok API anahtarı: ")
            .replace("Grok API error", "Grok API hatası")
            .replace("No response from Grok API", "Grok API'den yanıt alınamadı")
            .replace("Grok request timeout: ", "Grok isteğinde zaman aşımı: ")
            .replace("Network error - cannot reach Grok: ", "Ağ hatası - Grok'a ulaşılamadı: ")
            .replace("Local LLM service not initialized", "Yerel LLM hizmeti başlatılmadı")
            .replace("Local LLM API error", "Yerel LLM API hatası")
            .replace("No response from Local LLM", "Yerel LLM'den yanıt alınamadı")
            .replace("Local LLM request timeout: ", "Yerel LLM isteğinde zaman aşımı: ")
            .replace("Network error - cannot reach Local LLM: ", "Ağ hatası - yerel LLM'ye ulaşılamadı: ")
